...
bentoo bench --tools tool_runners/tools_java.toml --runs BenchmarkJava-mutated/runs.toml --timeout 1200 BenchmarkJava-mutated-17-output
./scripts/draw-benchamrk-summary-charts.py BenchmarkJava-mutated-17-output BenchmarkJava-mutated-17 benchmark_java_mutated_17
