...
bentoo template --tools tool_runners/tools_java_codeql.toml BenchmarkJava > BenchmarkJava/runs.toml
bentoo bench --tools tool_runners/tools_java_codeql.toml --runs BenchmarkJava/runs.toml --timeout 2400 BenchmarkJava-output
